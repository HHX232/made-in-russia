...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    return [
      {
        source: '/(.*)', // ✅ вместо /:path* чтобы точно матчить всё
        headers: [
          {
            ...
            value: `
              ...
              frame-src 'self' ${cdnUrl} https://telegram.org;
...
//           {
//             key: 'Content-Security-Policy',
//             value: "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://exporteru.b-cdn.net https://telegram.org;"
//           }
//         ]
//       }
//     ]
