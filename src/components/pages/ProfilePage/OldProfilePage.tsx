...
const ProfileHeader: FC<ProfileHeaderProps> = ({userData, isPageForVendor = true}) => {
...
const QuickActions: FC<QuickActionsProps> = ({onDevicesClick, onPaymentClick, isForVendor = true}) => {
...
const OldProfilePage: FC<{firstUserData?: User}> = ({firstUserData}) => {
    ...
    <div>
      ...
      <div className='container'>
        <div className={styles.profile__inner}>
          ...
          {/* ProfilePageBottomDelivery -- это на самом деле отдел мои комментарии */}
