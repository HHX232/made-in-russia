                ...
                >
                  <div className={styles.chat__avatar}>
                    {chat.product.imageUrl ? (
                      <img src={chat.product.imageUrl} alt={chat.product.name} />
                    ) : (
                      <div className={styles.placeholder}>{chat.product.name.charAt(0).toUpperCase()}</div>
                    )}
                  </div>

                  <div className={styles.chat__info}>
                    <div className={styles.chat__header}>
                      <h3 className={styles.chat__title}>{chat.product.name}</h3>
