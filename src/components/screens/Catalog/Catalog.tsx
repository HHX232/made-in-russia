...
const Catalog: FC<CatalogProps> = ({initialProducts, initialHasMore, isShowFilters = true}) => {
  ...
  return (
    <>
      <div className={`container  ${styles.top__fliters__container}`}>
        <div className={`${styles.top__fliters__container__inner}`}>
          ...
          <div className={styles.drop__list__filter__box}>
            ...
            >
              ...
              />
              <path d='M6.72949 21V3' stroke='#292D32' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
              <path
                ...
                strokeLinejoin='round'
              />
              <path d='M17.2695 3V21' stroke='#292D32' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
            </svg>
            <DropList
