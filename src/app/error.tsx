...
const translations = {
  ...
  hi: {
    title: 'एक त्रुटि हुई!',
    description: 'दुर्भाग्य से कुछ गलत हो गया। हम इस समस्या को ठीक करने पर काम कर रहे हैं।',
    button: 'फिर से कोशिश करें',
    back: 'वापस जाएं',
    technical: 'तकनीकी जानकारी',
    contact: 'यदि समस्या बनी रहती है, तो हमसे संपर्क करें:',
    phone: 'फ़ोन:',
    email: 'ईमेल:'
  }
}
